...
| **API keys** | Web: `sessionStorage` only. macOS desktop: memory plus opt-in Keychain (`src/desktop/`, `src-tauri/`). Never persist desktop keys in browser storage or files. See `docs/desktop.md`. |
