...
export function AuthErrorModal({
  ...
  if (error.code !== "invite_required") return null;
  ...
  return (
    ...
    >
      ...
      >
        <span className="mono text-fg-accent">INVITE ONLY</span>
        ...
        <p id="invite-required-description" className="mt-2 text-sm text-fg-secondary">
          Precipice is currently invite-only. Ask an administrator to invite the Google account you
          used, then try signing in again from Publish.
        </p>
